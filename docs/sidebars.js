...
const sidebars = {
  ...
  menuExamplesSidebar: [
    'menu-examples/menu-examples-intro',
    {
      ...
      label: 'Vertical Menu',
      collapsed: false,
      link: { type: 'doc', id: 'menu-examples/vertical-examples/vertical-menu-props' },
      items: [
        {
          type: 'category',
          label: 'Vertical Nav',
          link: { type: 'doc', id: 'menu-examples/vertical-examples/vertical-nav/vertical-nav-props' },
          items: [
        ...
        },
        {
          type: 'category',
          label: 'Menu',
          link: { type: 'doc', id: 'menu-examples/vertical-examples/menu/menu-props' },
          items: [
        ...
        },
        {
          type: 'category',
          label: 'Menu Section',
          link: { type: 'doc', id: 'menu-examples/vertical-examples/menu-section/menu-section-props' },
          items: [
        ...
        },
        {
          type: 'category',
          label: 'Menu Item',
          link: { type: 'doc', id: 'menu-examples/vertical-examples/menu-item/menu-item-props' },
          items: [
        ...
        },
        {
          type: 'category',
          label: 'Sub Menu',
          link: { type: 'doc', id: 'menu-examples/vertical-examples/submenu/submenu-props' },
          items: [
    ...
    },
    {
      ...
      collapsed: false,
      link: { type: 'doc', id: 'menu-examples/horizontal-examples/horizontal-menu-props' },
      items: [
        {
          type: 'category',
          label: 'Horizontal Nav',
          link: { type: 'doc', id: 'menu-examples/horizontal-examples/horizontal-nav/horizontal-nav-props' },
          items: [
        ...
        },
        {
          type: 'category',
          label: 'Menu',
          link: { type: 'doc', id: 'menu-examples/horizontal-examples/menu/menu-props' },
          items: [
        ...
        },
        {
          type: 'category',
          label: 'Menu Item',
          link: { type: 'doc', id: 'menu-examples/horizontal-examples/menu-item/menu-item-props' },
          items: [
        ...
        },
        {
          type: 'category',
          label: 'Sub Menu',
          link: { type: 'doc', id: 'menu-examples/horizontal-examples/submenu/submenu-props' },
          items: [
