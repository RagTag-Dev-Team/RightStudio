...
const SliderError = styled(MuiSlider)<SliderProps>(({ theme }) => ({
  ...
  '& .MuiSlider-thumb:hover, & .MuiSlider-thumb.Mui-focusVisible': {
    boxShadow: `0 0 0 8px ${alpha(theme.palette.error.main, 0.16)}`
  },
  '@media(hover:none)': {
    '& .MuiSlider-thumb:hover, & .MuiSlider-thumb.Mui-focusVisible': {
      boxShadow: 'none'
  ...
  '& .MuiSlider-thumb.Mui-focusVisible.Mui-active': {
    boxShadow: `0 0 0 14px ${alpha(theme.palette.error.main, 0.16)}`
  }
}))
...
const SliderWarning = styled(MuiSlider)<SliderProps>(({ theme }) => ({
  ...
  '& .MuiSlider-thumb.Mui-focusVisible.Mui-active': {
    boxShadow: `0 0 0 14px ${alpha(theme.palette.warning.main, 0.16)}`
  }
}))
...
const SliderInfo = styled(MuiSlider)<SliderProps>(({ theme }) => ({
  ...
  '& .MuiSlider-thumb.Mui-focusVisible.Mui-active': {
    boxShadow: `0 0 0 14px ${alpha(theme.palette.info.main, 0.16)}`
  }
}))
