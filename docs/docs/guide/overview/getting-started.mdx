...
**Menu Examples:** To learn how to create and customize the menu, and understand the different menu types available, refer this [guide](/docs/menu-examples/intro).
