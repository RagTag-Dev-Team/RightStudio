...
**User Interface:** To get familiar with the foundation, components and form elements of the template, refer this [guide](/docs/user-interface/foundation).
...
Our [component customization guide](/docs/guide/customizing-our-component) is a must-read for those looking to tweak/change our components to fit their project's unique requirements.
