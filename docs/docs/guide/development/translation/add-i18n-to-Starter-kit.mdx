...
- Add the following dependency to your project:
  ...
  <Tabs>
    <TabItem value="pnpm">
      <CodeBlock language='bash'>pnpm install @formatjs/intl-localematcher @types/negotiator negotiator</CodeBlock>
    </TabItem>
    <TabItem value="yarn">
      <CodeBlock language='bash'>yarn install @formatjs/intl-localematcher @types/negotiator negotiator</CodeBlock>
    </TabItem>
    <TabItem value="npm">
      <CodeBlock language='bash'>npm install @formatjs/intl-localematcher @types/negotiator negotiator</CodeBlock>
    </TabItem>
  </Tabs>
