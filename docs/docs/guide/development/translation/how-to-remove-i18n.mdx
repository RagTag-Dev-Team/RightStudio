...
- Go to the `src/components/layout/shared/UserDetails.tsx` file and make the following changes.
...
- Go to the `src/views/login/LoginForm.tsx` file and make the following changes.
