...
- Go to the `src/components/layout/shared/Logo.tsx` file and make the following changes.
    ...
    2. Remove the unused variable and it's releted import from the `Logo.tsx` file.
...
- Go to the `src/components/layout/shared/UserDetails.tsx` file and make the following changes.
    ...
    1. Replace the following:
        ...
        + router.push('/login')
        ```  
    2. Remove the unused variable and it's releted import.    
...
- Go to the `src/components/layout/shared/search/DefaultSuggestions.tsx` file and make the following changes.
    ...
    2. Replace the following:
        ...
        ```diff
        - <Link href={getLocalizedUrl(item.href, locale as Locale)}
        + <Link href={item.href}
        ```

- Go to the `src/components/layout/shared/search/index.tsx` file and make the following changes.

    1. Replace the following in `searchActions` function:
...
- Remove the following files and it's related import from the whole project:
