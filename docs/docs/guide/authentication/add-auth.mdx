...
- add the `src/middleware.ts` file from the full-version to your project
  ...
  :::warning Note!
  In the `src/middleware.ts` file, the code for i18n has also been implemented. If you don't need i18n, you can remove its code by following [this guide](/docs/guide/development/translation/how-to-remove-i18n/manually#step-3-modify-middleware-file).
