...
<IframeWindow url="https://demos.pixinvent.com/vuexy-nextjs-admin-template/demo-1/en/hook-examples/use-horizontal-nav/is-breakpoint-reached" />
...
<IframeWindow url="https://demos.pixinvent.com/vuexy-nextjs-admin-template/demo-1/en/hook-examples/use-horizontal-nav/update-is-breakpoint-reached" />
