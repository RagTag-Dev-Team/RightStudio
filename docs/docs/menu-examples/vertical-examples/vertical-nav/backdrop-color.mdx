...
import SourceCode from '!!raw-loader!../../../../../typescript-version/full-version/src/app/[lang]/menu-examples/vertical-menu/vertical-nav/backdrop-color/page'
...
<IframeWindow url='http://localhost:3000/menu-examples/vertical-menu/vertical-nav/backdrop-color' />
