...
import SourceCode from '!!raw-loader!../../../../../typescript-version/full-version/src/app/[lang]/menu-examples/vertical-menu/vertical-nav/breakpoint/page'
...
<IframeWindow url='http://localhost:3000/menu-examples/vertical-menu/vertical-nav/breakpoint' />
