...
import SourceCodeWithParams from '!!raw-loader!../../../../../typescript-version/full-version/src/app/[lang]/menu-examples/vertical-menu/menu/expand-icon/with-params/page'
import SourceCodeWithoutParams from '!!raw-loader!../../../../../typescript-version/full-version/src/app/[lang]/menu-examples/vertical-menu/menu/expand-icon/without-params/page'
...
<IframeWindow url='http://localhost:3000/menu-examples/vertical-menu/menu/expand-icon/with-params' />
...
<IframeWindow url='http://localhost:3000/menu-examples/vertical-menu/menu/expand-icon/without-params' />
