...
<IframeWindow url='http://localhost:3000/en/menu-examples/vertical-menu/menu/expand-icon/with-params' />
...
<IframeWindow url='http://localhost:3000/en/menu-examples/vertical-menu/menu/expand-icon/without-params' />
