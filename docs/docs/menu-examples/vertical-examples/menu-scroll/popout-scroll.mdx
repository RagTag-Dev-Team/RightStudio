...
export const updatedSourceCodeBrowserScroll = SourceCodeBrowserScroll.replace(
  /customStyles=\{\{([\s\S]*?)\}\}/,
  ""
)
...
export const updatedSourceCodePerfectScroll = SourceCodePerfectScroll.replace(
  /customStyles=\{\{([\s\S]*?)\}\}/,
  ""
)
  .replace(/backgroundColor='.*'/, "")
