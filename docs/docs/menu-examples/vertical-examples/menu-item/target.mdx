...
import SourceCode from '!!raw-loader!../../../../../typescript-version/full-version/src/app/[lang]/menu-examples/vertical-menu/menu-item/target/page'
...
<IframeWindow url='http://localhost:3000/menu-examples/vertical-menu/menu-item/target' />
