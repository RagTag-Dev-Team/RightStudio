...
import SourceCode from '!!raw-loader!../../../../../typescript-version/full-version/src/app/[lang]/menu-examples/vertical-menu/menu-item/on-click/page'
...
<IframeWindow url='http://localhost:3000/menu-examples/vertical-menu/menu-item/on-click' />
