...
import SourceCode from '!!raw-loader!../../../../../typescript-version/full-version/src/app/[lang]/menu-examples/vertical-menu/submenu/prefix/page'
...
<IframeWindow url='http://localhost:3000/menu-examples/vertical-menu/submenu/prefix' />
