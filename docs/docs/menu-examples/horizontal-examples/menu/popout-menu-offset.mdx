...
import SourceCodeWithParams from '!!raw-loader!../../../../../typescript-version/full-version/src/app/[lang]/menu-examples/horizontal-menu/menu/popout-menu-offset/with-params/page'
import SourceCodeWithoutParams from '!!raw-loader!../../../../../typescript-version/full-version/src/app/[lang]/menu-examples/horizontal-menu/menu/popout-menu-offset/without-params/page'
...
<IframeWindow url='http://localhost:3000/menu-examples/horizontal-menu/menu/popout-menu-offset/with-params' />
...
<IframeWindow url='http://localhost:3000/menu-examples/horizontal-menu/menu/popout-menu-offset/without-params' />
