...
<IframeWindow url='http://localhost:3000/en/menu-examples/horizontal-menu/menu/menu-item-styles/with-params' />
...
<IframeWindow url='http://localhost:3000/en/menu-examples/horizontal-menu/menu/menu-item-styles/without-params' />
