...
import WithParams from "@docPages/menu-examples/horizontal-menu/menu/menu-item-styles/WithParams";
import WithoutParams from "@docPages/menu-examples/horizontal-menu/menu/menu-item-styles/WithoutParams";
import TsToJsCodeSnippet from "@docComponents/ts-js-code";
import SourceCodeWithParams from "!!raw-loader!@docPages/menu-examples/horizontal-menu/menu/menu-item-styles/WithParams";
import SourceCodeWithoutParams from "!!raw-loader!@docPages/menu-examples/horizontal-menu/menu/menu-item-styles/WithoutParams";
...
<BrowserWindow url="/horizontal-menu/menu/menu-item-styles/with-params">
  <Provider>
    <WithParams />
  </Provider>
</BrowserWindow>
...
<BrowserWindow url="/horizontal-menu/menu/menu-item-styles/without-params">
  <Provider>
    <WithoutParams />
  </Provider>
</BrowserWindow>
