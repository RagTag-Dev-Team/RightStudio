    ...
    },
    {
      ...
      items: [
        ...
        'guide/development/nextjs-api',
        {
          ...
          items: ['guide/development/apps-and-pages-setup/pages', 'guide/development/apps-and-pages-setup/apps']
        }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          type: 'category',
          label: 'Libs',
          items: ['guide/components/libs/apex-charts', 'guide/components/libs/recharts', 'guide/components/libs/editor']
        },
        {
          type: 'category',
          label: 'Styled Libs',
