    ...
    <div className='flex'>
      <VerticalNav customBreakpoint='200px'>
        <Menu menuItemStyles={{ button: { paddingBlock: '12px' } }}>
          <MenuItem
            href='/menu-examples/vertical-menu/menu-item/on-active-change/with-params'
          ...
          <MenuItem href='/menu-examples/vertical-menu/menu-item/on-active-change/with-params/inside'>
            Calendar
          </MenuItem>
