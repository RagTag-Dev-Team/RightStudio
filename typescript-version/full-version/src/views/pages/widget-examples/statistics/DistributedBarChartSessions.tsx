...
const DistributedBarChartSessions = () => {
  // Hooks
  ...
  return (
    <Card>
      ...
      <CardContent className='flex flex-col gap-3 pbs-3'>
        <AppReactApexCharts type='bar' height={70} width='100%' options={options} series={series} />
...
export default DistributedBarChartSessions
